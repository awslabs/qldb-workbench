...
import {Box, Collapse, IconButton, SvgIcon, SvgIconProps, Tooltip} from "@material-ui/core";
...
function tableTreeItem(t: TableInfo): JSX.Element {
    return <StyledTreeItem key={t.tableId} nodeId={t.tableId} label={t.name + (t.status == "INACTIVE" ? " (INACTIVE)" : "")} />
}
